...
const SectionDivider = ({ title }) => (
  <div style={{ display:"flex", alignItems:"center", gap:12, margin:"28px 0 16px" }}>
    ...
    <span style={{ fontWeight:800, fontSize:12, letterSpacing:"0.12em",
      color:"#1e2b4a", textTransform:"uppercase" }}>{title}</span>
    <div style={{ flex:1, height:1, background:"#e5e7eb" }} />
  </div>
);
    ...
    <table style={{ width:"100%", borderCollapse:"collapse", fontSize:12 }}>
      <thead>
        <tr>{["Details","Stated","Verified"].map(h => (
          <th key={h} style={{ background:"#1e2b4a", color:"#fff",
            padding:"9px 14px", textAlign:"left",
            fontWeight:700, fontSize:11, letterSpacing:"0.04em" }}>{h}</th>
        ))}</tr>
      </thead>
      <tbody>
        {rows.map(([d,s,v], i) => (
...
const ClearedBox = ({ label }) => (
  <div style={{ margin:"12px 20px 16px", background:"#f0fdf4",
    ...
    <>
      ...
      <div style={{ minHeight:"100vh",
        ...
        <div style={{ maxWidth:900, margin:"0 auto" }}>
          ...
          <div className="no-print" style={{ display:"flex", alignItems:"flex-start",
            ...
            <div>
              <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:6 }}>
                <div style={{ background:"linear-gradient(135deg,#1e2b4a,#2d4070)",
                  color:"#fff", fontWeight:800, fontSize:18,
                  padding:"6px 14px", borderRadius:8, letterSpacing:"0.06em" }}>MYSDOM</div>
              ...
              <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr" }}>
                <div style={{ padding:20, borderRight:"1px solid #f3f4f6" }}>
                  <p style={{ margin:"0 0 4px", fontSize:11, fontWeight:700,
                    color:"#7bc142", textTransform:"uppercase", letterSpacing:"0.08em" }}>Final Report</p>
                  ...
                  <p style={{ margin:"0 0 4px", fontSize:11, fontWeight:700, color:"#1e2b4a",
                    textTransform:"uppercase", letterSpacing:"0.06em" }}>Package Opted</p>
                  {services.length > 0
                    ? services.map(s => (
                  ...
                  <p style={{ margin:"14px 0 4px", fontSize:11, fontWeight:700, color:"#1e2b4a",
                    textTransform:"uppercase", letterSpacing:"0.06em" }}>Date of Request</p>
                ...
                <div style={{ padding:20, background:"#f9fafb" }}>
                  <p style={{ margin:"0 0 6px", fontSize:11, fontWeight:700, color:"#1e2b4a",
                    textTransform:"uppercase", letterSpacing:"0.06em", textAlign:"right" }}>Prepared By</p>
          ...
          <div className="rs">
            ...
            <Card>
              ...
              <div style={{ overflowX:"auto", paddingBottom:4 }}>
                <table style={{ width:"100%", borderCollapse:"collapse", fontSize:12 }}>
                  <thead>
                    <tr>{["MYS#","Applicant","Organisation","Package","Address","Education","Employment"].map(h => (
                      <th key={h} style={{ background:"#1e2b4a", color:"#fff",
                        padding:"9px 10px", textAlign:"center", fontWeight:700, fontSize:11 }}>{h}</th>
                    ))}</tr>
                  </thead>
                  <tbody>
                    <tr style={{ background:"#f9fafb" }}>
                      ...
                      {["Cleared","Cleared","Cleared"].map((v, i) => (
                        <td key={i} style={{ padding:"9px 10px", textAlign:"center",
          ...
          {/* ── Education Check ── */}
          <div className="rs">
            <SectionDivider title="Education Check" />
            <Card>
              <CardHeader icon="🎓" title="EDUCATION CHECK"
                right={<Badge label="Cleared" color={{ bg:"#d1fae5", txt:"#065f46" }} />}
              />
              <div style={{ padding:"12px 20px 4px" }}>
                <span style={{ fontSize:11, fontWeight:700, color:"#6b7280", textTransform:"uppercase" }}>
                  Education Verification — <span style={{ color:"#27ae60" }}>Completed</span>
                </span>
              </div>
              <VerifyTable rows={[
              ...
              {data.edu_doc && (
                <div style={{ padding:"0 20px 16px" }}>
                  <p style={{ margin:"0 0 6px", fontSize:11, fontWeight:700, color:"#6b7280",
                    textTransform:"uppercase", letterSpacing:"0.06em" }}>Education Certificate</p>
                  <FilePill path={data.edu_doc} base_url={base_url} label="Education Certificate" />
                </div>
              )}
            </Card>
          </div>
                ...
                ? (
                    <div style={{ padding:"16px 20px", display:"grid",
                      ...
                      {services.map(sv => {
                        ...
                        return (
                          <div key={sv.id} style={{ border:`1.5px solid ${sc.bg}`,
